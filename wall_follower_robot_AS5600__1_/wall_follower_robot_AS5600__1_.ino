...
<style>
  ...
  *{box-sizing:border-box;}
  body{
    ...
    color:var(--text);
    background:
      radial-gradient(circle at 15% -10%, #1c3f5f 0%, transparent 55%),
      radial-gradient(circle at 100% 10%, #14314d 0%, transparent 45%),
      linear-gradient(180deg,#0b1a2c 0%,#060f1a 100%);
